...
import { MdButtonModule, MdCheckboxModule, MdInputModule, MdAutocompleteModule, MdGridListModule, MdDatepickerModule, MdToolbarModule, MdCardModule,MdTableModule,MdPaginatorModule} from '@angular/material';
...
@NgModule({
  ...
  imports: [
    ...
    MdCardModule, BrowserAnimationsModule,MdTableModule
  ],
