...
export class ExamCenterCommitteeComponent implements OnInit {
    ...
    displayedColumns = ['ลำดับ','ชื่อ', 'นามสกุล', 'ตำแหน่ง','อาคารสอบ','ข้อมูล', 'แก้ไข', 'ลบ'];
    ...
    viewUser(userId) {
      this._router.navigate(['examCenter/view-committee/' + userId]);
    }
  
    editUser(userId) {
      this._router.navigate(['examCenter/edit-committee/' + userId]);
    }
  
    deleteUser(userId) {
      this._router.navigate(['examCenter/delete-committee/' + userId]);
    }
