...
.mat-body-2,
.mat-body-strong { font:500 14px/24px Roboto,"Helvetica Neue",sans-serif; }

.mat-body,
.mat-body-1,
.mat-typography { font:400 14px/20px Roboto,"Helvetica Neue",sans-serif; }
...
.mat-caption,
.mat-small { font:400 12px/20px Roboto,"Helvetica Neue",sans-serif; }
...
.mat-card-subtitle { font-size:14px; }
...
.mat-grid-tile-header { font-size:14px; }
...
.mat-grid-tile-header .mat-line:nth-child(n+2) { font-size:12px; }
...
.mat-input-suffix .mat-icon { font-size:150%; }
...
.mat-input-suffix .mat-icon-button .mat-icon { line-height:1.5; }
...
.mat-nav-list .mat-list-item { font-size:16px; }
...
.mat-nav-list .mat-list-item .mat-line:nth-child(n+2) { font-size:14px; }

.mat-list .mat-subheader,
.mat-nav-list .mat-subheader { font:500 14px/24px Roboto,"Helvetica Neue",sans-serif; }

.mat-list[dense] .mat-list-item,
.mat-nav-list[dense] .mat-list-item { font-size:12px; }
...
.mat-nav-list[dense] .mat-list-item .mat-line:nth-child(n+2) { font-size:12px; }

.mat-list[dense] .mat-subheader,
.mat-nav-list[dense] .mat-subheader { font:500 12px Roboto,"Helvetica Neue",sans-serif; }
...
.mat-option:hover:not(.mat-option-disabled) { background:rgba(0,0,0,.04); }

.mat-option.mat-selected.mat-primary,
.mat-primary .mat-option.mat-selected { color:#F98743; }

.mat-accent .mat-option.mat-selected,
.mat-option.mat-selected.mat-accent { color:#ffd740; }

.mat-option.mat-selected.mat-warn,
.mat-warn .mat-option.mat-selected { color:#F98743; }
...
.mat-pseudo-checkbox-indeterminate.mat-primary { background:#F98743; }

.mat-accent .mat-pseudo-checkbox-checked,
.mat-accent .mat-pseudo-checkbox-indeterminate,
.mat-pseudo-checkbox-checked.mat-accent,
.mat-pseudo-checkbox-indeterminate.mat-accent { background:#ffd740; }

.mat-pseudo-checkbox-checked.mat-warn,
.mat-pseudo-checkbox-indeterminate.mat-warn,
.mat-warn .mat-pseudo-checkbox-checked,
.mat-warn .mat-pseudo-checkbox-indeterminate { background:#F98743; }

.mat-pseudo-checkbox-checked.mat-pseudo-checkbox-disabled,
.mat-pseudo-checkbox-indeterminate.mat-pseudo-checkbox-disabled { background:#b0b0b0; }
...
.mat-button,
.mat-icon-button { background:0 0; }

.mat-button.mat-primary .mat-button-focus-overlay,
.mat-icon-button.mat-primary .mat-button-focus-overlay { background-color:rgba(103,58,183,.12); }

.mat-button.mat-accent .mat-button-focus-overlay,
.mat-icon-button.mat-accent .mat-button-focus-overlay { background-color:rgba(255,215,64,.12); }

.mat-button.mat-warn .mat-button-focus-overlay,
.mat-icon-button.mat-warn .mat-button-focus-overlay { background-color:rgba(244,67,54,.12); }

.mat-button[disabled] .mat-button-focus-overlay,
.mat-icon-button[disabled] .mat-button-focus-overlay { background-color:transparent; }

.mat-button.mat-primary,
.mat-icon-button.mat-primary { color:#F98743; }

.mat-button.mat-accent,
.mat-icon-button.mat-accent { color:#ffd740; }

.mat-button.mat-warn,
.mat-icon-button.mat-warn { color:#F98743; }
...
.mat-icon-button[disabled][disabled] { color:rgba(0,0,0,.38); }
...
.mat-raised-button.mat-primary { color:rgba(255,255,255,.87); }

.mat-fab.mat-accent,
.mat-mini-fab.mat-accent,
.mat-raised-button.mat-accent { color:rgba(0,0,0,.87); }

.mat-fab.mat-warn,
.mat-mini-fab.mat-warn,
.mat-raised-button.mat-warn { color:#fff; }
...
.mat-raised-button[disabled][disabled] { color:rgba(0,0,0,.38); }

.mat-fab.mat-primary,
.mat-mini-fab.mat-primary,
.mat-raised-button.mat-primary { background-color:#F98743; }

.mat-fab.mat-accent,
.mat-mini-fab.mat-accent,
.mat-raised-button.mat-accent { background-color:#ffd740; }

.mat-fab.mat-warn,
.mat-mini-fab.mat-warn,
.mat-raised-button.mat-warn { background-color:#F98743; }
...
.mat-raised-button.mat-primary[disabled],
.mat-raised-button.mat-warn[disabled],
.mat-raised-button[disabled][disabled] { background-color:rgba(0,0,0,.12); }

.mat-fab.mat-primary .mat-ripple-element,
.mat-mini-fab.mat-primary .mat-ripple-element,
.mat-raised-button.mat-primary .mat-ripple-element { background-color:rgba(255,255,255,.2); }

.mat-fab.mat-accent .mat-ripple-element,
.mat-mini-fab.mat-accent .mat-ripple-element,
.mat-raised-button.mat-accent .mat-ripple-element { background-color:rgba(0,0,0,.2); }

.mat-fab.mat-warn .mat-ripple-element,
.mat-mini-fab.mat-warn .mat-ripple-element,
.mat-raised-button.mat-warn .mat-ripple-element { background-color:rgba(255,255,255,.2); }
...
.mat-checkbox-indeterminate.mat-primary .mat-checkbox-background { background-color:#F98743; }

.mat-checkbox-checked.mat-accent .mat-checkbox-background,
.mat-checkbox-indeterminate.mat-accent .mat-checkbox-background { background-color:#ffd740; }

.mat-checkbox-checked.mat-warn .mat-checkbox-background,
.mat-checkbox-indeterminate.mat-warn .mat-checkbox-background { background-color:#F98743; }

.mat-checkbox-disabled.mat-checkbox-checked .mat-checkbox-background,
.mat-checkbox-disabled.mat-checkbox-indeterminate .mat-checkbox-background { background-color:#b0b0b0; }
...
.mat-header-row,
.mat-row { border-bottom-color:rgba(0,0,0,.12); }
...
.mat-calendar-previous-button { color:rgba(0,0,0,.54); }
...
:not(.mat-calendar-body-disabled):hover>.mat-calendar-body-cell-content:not(.mat-calendar-body-selected) { background-color:rgba(0,0,0,.04); }
...
.mat-icon.mat-primary { color:#F98743; }

.mat-icon.mat-accent { color:#ffd740; }

.mat-icon.mat-warn { color:#F98743; }

.mat-input-placeholder { color:rgba(0,0,0,.38); }

.mat-focused .mat-input-placeholder { color:#F98743; }
...
*   แก้เป็นสีโรงเรียน
*/
.mat-focused .mat-input-placeholder.mat-warn { color:#F98743; }

.mat-input-element:disabled { color:rgba(0,0,0,.38); }

.mat-focused .mat-input-placeholder.mat-float .mat-placeholder-required,
input.mat-input-element:-webkit-autofill+.mat-input-placeholder .mat-placeholder-required { color:#ffd740; }

.mat-input-underline { background-color:rgba(0,0,0,.12); }

.mat-input-ripple { background-color:rgba(252, 117, 24, 0.93); }

.mat-input-ripple.mat-accent { background-color:#ffd740; }

.mat-input-ripple.mat-warn { background-color:#F98743; }

.mat-input-invalid .mat-input-placeholder { color:#F98743; }

.mat-input-invalid .mat-input-placeholder.mat-accent,
.mat-input-invalid .mat-input-placeholder.mat-float .mat-placeholder-required { color:#F98743; }

.mat-input-invalid .mat-input-ripple { background-color:#F98743; }

.mat-input-error { color:#F98743; }

.mat-list .mat-list-item,
.mat-nav-list .mat-list-item { color:rgba(0,0,0,.87); }

.mat-list .mat-subheader,
.mat-nav-list .mat-subheader { color:rgba(0,0,0,.54); }
...
.mat-nav-list .mat-list-item:hover { background:rgba(0,0,0,.04); }
...
.mat-menu-item:hover:not([disabled]) { background:rgba(0,0,0,.04); }
...
.mat-icon-button[disabled] .mat-paginator-increment { border-color:rgba(0,0,0,.38); }
...
.mat-progress-bar-fill::after { background-color:#F98743; }
...
.mat-progress-bar.mat-warn .mat-progress-bar-fill::after { background-color:#F98743; }

.mat-progress-spinner path,
.mat-spinner path { stroke:#F98743; }

.mat-progress-spinner.mat-accent path,
.mat-spinner.mat-accent path { stroke:#ffd740; }

.mat-progress-spinner.mat-warn path,
.mat-spinner.mat-warn path { stroke:#F98743; }
...
.mat-radio-disabled .mat-radio-ripple .mat-ripple-element { background-color:rgba(0,0,0,.38); }

.mat-radio-disabled .mat-radio-label-content { color:rgba(0,0,0,.38); }

.mat-radio-button.mat-primary.mat-radio-checked .mat-radio-outer-circle { border-color:#F98743; }

.mat-radio-button.mat-primary .mat-radio-inner-circle { background-color:#F98743; }
...
.mat-radio-button.mat-warn.mat-radio-checked .mat-radio-outer-circle { border-color:#F98743; }

.mat-radio-button.mat-warn .mat-radio-inner-circle { background-color:#F98743; }

.mat-radio-button.mat-warn .mat-radio-ripple .mat-ripple-element { background-color:rgba(244,67,54,.26); }

.mat-select-arrow,
.mat-select-trigger { color:rgba(0,0,0,.38); }
...
.mat-select-content,
.mat-select-panel-done-animating { background:#fff; }

.mat-select-value { color:rgba(0,0,0,.87); }

.mat-select:focus:not(.mat-select-disabled).mat-primary .mat-select-arrow,
.mat-select:focus:not(.mat-select-disabled).mat-primary .mat-select-trigger { color:#F98743; }

.mat-select:focus:not(.mat-select-disabled).mat-primary .mat-select-underline { background-color:#F98743; }

.mat-select:focus:not(.mat-select-disabled).mat-accent .mat-select-arrow,
.mat-select:focus:not(.mat-select-disabled).mat-accent .mat-select-trigger { color:#ffd740; }
...
.mat-select:not(:focus).ng-invalid.ng-touched:not(.mat-select-disabled) .mat-select-trigger { color:#F98743; }

.mat-select:focus:not(.mat-select-disabled).mat-warn .mat-select-underline,
.mat-select:not(:focus).ng-invalid.ng-touched:not(.mat-select-disabled) .mat-select-underline { background-color:#F98743; }
...
.mat-slide-toggle.mat-primary.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb { background-color:#F98743; }
...
.mat-slide-toggle.mat-warn.mat-checked:not(.mat-disabled) .mat-slide-toggle-thumb { background-color:#F98743; }
...
.mat-primary .mat-slider-track-fill { background-color:#F98743; }

.mat-primary .mat-slider-thumb-label-text { color:rgba(255,255,255,.87); }

.mat-accent .mat-slider-thumb,
.mat-accent .mat-slider-thumb-label,
.mat-accent .mat-slider-track-fill { background-color:#ffd740; }

.mat-accent .mat-slider-thumb-label-text { color:rgba(0,0,0,.87); }

.mat-warn .mat-slider-thumb,
.mat-warn .mat-slider-thumb-label,
.mat-warn .mat-slider-track-fill { background-color:#F98743; }
...
.mat-slider:hover .mat-slider-track-background { background-color:rgba(0,0,0,.38); }

.mat-slider-disabled .mat-slider-thumb,
.mat-slider-disabled .mat-slider-track-background,
.mat-slider-disabled .mat-slider-track-fill { background-color:rgba(0,0,0,.26); }
...
.mat-slider-min-value.mat-slider-thumb-label-showing .mat-slider-thumb-label { background-color:#000; }

.mat-slider-min-value.mat-slider-thumb-label-showing.cdk-focused .mat-slider-thumb,
.mat-slider-min-value.mat-slider-thumb-label-showing.cdk-focused .mat-slider-thumb-label { background-color:rgba(0,0,0,.26); }
...
.mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover .mat-slider-thumb { border-color:rgba(0,0,0,.38); }

.mat-slider-min-value:not(.mat-slider-thumb-label-showing).cdk-focused.mat-slider-disabled .mat-slider-thumb,
.mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover.mat-slider-disabled .mat-slider-thumb { border-color:rgba(0,0,0,.26); }
...
.mat-tab-header,
.mat-tab-nav-bar { border-bottom:1px solid rgba(0,0,0,.12); }
...
.mat-ink-bar { background-color:#F98743; }

.mat-tab-label,
.mat-tab-link { color:rgba(0,0,0,.87); }

.mat-tab-label.mat-tab-disabled,
.mat-tab-link.mat-tab-disabled { color:rgba(0,0,0,.38); }
